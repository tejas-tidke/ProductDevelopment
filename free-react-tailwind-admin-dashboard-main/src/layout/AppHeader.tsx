...
bg-gradient-to-r from-[#C8C3EA] to-[#74D1CF] 
border-b border-[#A89FE0] 
z-[99999] 
dark:bg-gradient-to-r dark:from-[#8f89c9] dark:to-[#4ba9a7] dark:border-[#6d6799]">
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          <button
            className="items-center justify-center w-10 bg-white h-10 text-gray-500 border-gray-200 rounded-lg z-100 dark:border-gray-800 lg:flex dark:text-gray-400 lg:h-11 lg:w-11 lg:border"
