    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-white/[0.03]">
            <h4 className="text-sm font-semibold text-gray-800 dark:text-white/90">Spend Breakdown</h4>
            <div className="mt-4">
              {/* Placeholder semicircle / pie chart */}
              <div className="h-28 w-full rounded-full bg-gradient-to-r from-emerald-400 to-emerald-200" />
            </div>
          </div>
        </div>
      </div>
